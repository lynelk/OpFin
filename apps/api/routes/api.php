...
use App\Http\Controllers\Api\CustomerComplianceController;
...
use App\Http\Controllers\Api\UmraOperationsController;
...
Route::middleware(['auth:sanctum', 'throttle:api', 'role:platform_admin,operations,support'])->group(function () {
    ...
    Route::get('/admin/umra/credit-reference-submissions', [UmraOperationsController::class, 'creditReferenceSubmissions']);
    Route::post('/admin/umra/credit-reference-submissions/{submission}/retry', [UmraOperationsController::class, 'retryCreditReferenceSubmission']);
    Route::get('/admin/umra/npl-controls', [UmraOperationsController::class, 'nplControls']);
    Route::post('/admin/umra/loans/{loan}/evaluate-npl', [UmraOperationsController::class, 'evaluateNpl']);
    Route::get('/admin/umra/term-variations', [UmraOperationsController::class, 'variations']);
    Route::post('/admin/umra/loans/{loan}/term-variations', [UmraOperationsController::class, 'proposeVariation']);
    Route::post('/admin/umra/term-variations/{variation}/umra-approval', [UmraOperationsController::class, 'recordUmraApproval']);
    Route::post('/admin/umra/term-variations/{variation}/apply', [UmraOperationsController::class, 'applyVariation']);
});
