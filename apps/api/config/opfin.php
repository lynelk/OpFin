...
return [
    ...
    'credit' => [
        ...
        'legacy_manual_application_status_enabled' => (bool) env('OPFIN_ENABLE_LEGACY_APPLICATION_STATUS_MUTATION', false),
        'legacy_manual_transaction_approval_enabled' => (bool) env('OPFIN_ENABLE_LEGACY_TRANSACTION_APPROVAL', false),
    ...
    'accounting' => [
        ...
        'integrity_readiness_max_age_minutes' => (int) env('OPFIN_INTEGRITY_READINESS_MAX_AGE_MINUTES', 15),
