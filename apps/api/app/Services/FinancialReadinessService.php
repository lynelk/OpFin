...
class FinancialReadinessService
{
    public function __construct(
        ...
        private readonly MobileMoneyProviderManager $moneyProviders,
    ) {}
    ...
    public function report(): array
    {
        ...
        $moneyMovement = $this->moneyProviders->readiness();
        ...
        $latestRun = $integrity['latest_run'] ?? null;
        $freshnessMinutes = max(1, (int) config('opfin.accounting.integrity_readiness_max_age_minutes', 15));
        $integrityFresh = $latestRun
            && $latestRun->completed_at
            && Carbon::parse($latestRun->completed_at)->greaterThanOrEqualTo(now()->subMinutes($freshnessMinutes));
        ...
        $checks = [
            ...
            'financial_integrity' => [
                ...
                'freshness_limit_minutes' => $freshnessMinutes,
            ],
        ];
