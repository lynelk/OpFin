...
class PartnerReportingController extends Controller
{
    ...
    public function recordServiceEconomics(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'provider_gross_cost_minor' => ['nullable', 'integer', 'min:0'],
            'provider_discount_minor' => ['nullable', 'integer', 'min:0'],
            'provider_net_cost_minor' => ['nullable', 'integer', 'min:0'],
            'customer_service_charge_minor' => ['nullable', 'integer', 'min:0'],
            'customer_platform_fee_minor' => ['nullable', 'integer', 'min:0'],
            'partner_commission_minor' => ['nullable', 'integer', 'min:0'],
            'cito_platform_fee_minor' => ['nullable', 'integer', 'min:0'],
            'opfin_platform_fee_minor' => ['nullable', 'integer', 'min:0'],
            'tax_amount_minor' => ['nullable', 'integer', 'min:0'],
            'net_settlement_to_provider_minor' => ['nullable', 'integer', 'min:0'],
            'gross_revenue_minor' => ['nullable', 'integer', 'min:0'],
