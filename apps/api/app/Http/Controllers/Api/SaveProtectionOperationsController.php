...
class SaveProtectionOperationsController extends Controller
{
    ...
    private function savingsProductValidator(Request $request, bool $partial = false, ?SavingsProduct $product = null): mixed
    {
        ...
        return Validator::make($request->all(), [
            ...
            'economics_config' => 'nullable|array',
            'economics_config.provider_gross_cost_minor' => 'nullable|integer|min:0',
            'economics_config.provider_discount_minor' => 'nullable|integer|min:0',
            'economics_config.customer_service_charge_minor' => 'nullable|integer|min:0',
            'economics_config.customer_platform_fee_minor' => 'nullable|integer|min:0',
            'economics_config.partner_commission_minor' => 'nullable|integer|min:0',
            'economics_config.cito_platform_fee_minor' => 'nullable|integer|min:0',
            'economics_config.opfin_platform_fee_minor' => 'nullable|integer|min:0',
            'economics_config.tax_amount_minor' => 'nullable|integer|min:0',
            'economics_config.net_settlement_to_provider_minor' => 'nullable|integer|min:0',
            'economics_config.price_book_version' => 'nullable|string|max:120',
            'economics_config.contract_version' => 'nullable|string|max:120',
    ...
    private function protectionProductValidator(Request $request, bool $partial = false, ?ProtectionProduct $product = null): mixed
    {
        ...
        return Validator::make($request->all(), [
            ...
            'country_code' => $prefix.'string|size:2',
            'currency' => $prefix.'string|size:3',
            'product_type' => [$partial ? 'sometimes' : 'required', Rule::in(['micro', 'loan', 'health', 'event', 'device', 'asset', 'life', 'funeral', 'personal_accident', 'agriculture', 'livestock', 'property', 'liability', 'group_life'])],
            'audience_scope' => ['sometimes', Rule::in(['personal', 'group', 'both'])],
