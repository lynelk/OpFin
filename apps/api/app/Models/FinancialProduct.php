...
class FinancialProduct extends Model {
 ...
 public function legalPassport() { return $this->belongsTo(LegalProductPassport::class, 'legal_product_passport_id'); }
 public function shariaApproval() { return $this->belongsTo(ShariaApproval::class, 'sharia_approval_id'); }
